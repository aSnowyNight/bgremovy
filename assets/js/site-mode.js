(() => {
  ...
  function applyMode(mode, save = true) {
    ...
    if (button) {
      ...
      button.setAttribute("aria-label", selected === PLAYFUL ? "Switch to professional mode" : "Switch to playful mode :3");
      button.setAttribute("title", selected === PLAYFUL ? "Switch to professional mode" : "Switch to playful mode :3");
    }
